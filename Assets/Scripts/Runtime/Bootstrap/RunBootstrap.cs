...
namespace DinoRush.Runtime
{
    ...
    public static class RunBootstrap
    {
        ...
        private static void Build()
        {
            ...
            // An empty pivot, not a mesh. The dinosaur itself is generated by RunController,
            // which owns the PlayerMotorConfig the model has to be sized against — see
            // DinosaurFactory for why the model cannot be built without it.
